...
export class CdkAppStack extends EnvironmentAwareStack {
  constructor(scope: Construct, id: string, props: APIStackProps) {
    ...
    const basicFunction = new NodejsFunction(
      this,
      `${this.deployEnvironment}-basicResponseFunction`,
      {
    ...
    const getBalancesFunction = new NodejsFunction(
      this,
      `${this.deployEnvironment}-getBalancesFunction`,
      {
    ...
    const addBalanceFuncton = new NodejsFunction(
      this,
      `${this.deployEnvironment}-addBalanceFunction`,
      {
    ...
    // api definition
    const basicRestApi = new LambdaRestApi(
      this,
      `${this.deployEnvironment}-restApi`,
      {
    ...
    const authorizer = new CfnAuthorizer(
      this,
      `${this.deployEnvironment}-cfnAuth`,
      {
